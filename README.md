...
![Figure : Image from one of the maps in the game](images/image1.png)
...
![Figure : Rougly mapped out enemy AI state tree](images/image2.jpeg)
...
![Figure : Slay the Spire STS Map](images/image3.png)
...
![Figure : System Architecture Graph](images/image4.png)
...
![Figure : Inventory with item in it](images/image5.png)
...
![Figure : Image of an Item Definition for a sword](images/image6.png)
...
![Figure : Image of architecture of the hard coded state machine](images/image7.png)
...
![Figure : Image of enemy attacking](images/image8.jpeg)

*Figure : Image of enemy attacking*

![Figure : Image of enemy attacking](images/image9.png)
...
![Figure : Image of the Player's hands holding a weapon with IK](images/image10.png)

*Figure : Image of the Player's hands holding a weapon with IK*

![Figure : Image of the Player's hands holding a weapon with IK](images/image11.png)
...
![Figure : The HUD when the player takes damage](images/image12.jpeg)

*Figure : The HUD when the player takes damage*

![Figure : The HUD when the player takes damage](images/image13.png)
...
![Figure : Enemy StateTree](images/image14.png)
...
![Figure : Item definition of poison rune](images/image15.png)
...
![Figure : Refactored Inventory](images/image16.jpeg)
...
![Figure : Poisson disk sampling](images/image17.png)
...
![Figure :Delaunay triangulation on sampled nodes](images/image18.png)
...
![Figure : Final version of the STS-Map](images/image21.png)
